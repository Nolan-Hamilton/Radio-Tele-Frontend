        ...
        <v-container v-show="!$store.state.isLoading">
            ...
            <v-list-tile v-if="this.data.type.value == 'Raster Scan'">
                <v-list-tile-content class="white--text">
                    ...
                    <v-flex>
                        <v-list-tile-sub-title class="pl-3" v-if="data.declination.value > 0">Right Ascension: 
                            {{ this.appointment.coordinate1.hours }} Hours 
                            {{ this.appointment.coordinate1.minutes }} Minute, 
                            <!-- {{this.appointment.coordinate1.seconds}} Seconds -->
                            Declination: +{{ this.appointment.coordinate1.declination }}
                        </v-list-tile-sub-title>
                        <v-list-tile-sub-title class="pl-3" v-if="data.declination.value <= 0">Right Ascension: 
                            {{ this.appointment.coordinate1.hours }} Hours 
                            {{ this.appointment.coordinate1.minutes }} Minutes, 
                            <!-- {{this.appointment.coordinate1.seconds}} Seconds --> 
                            Declination: {{ this.appointment.coordinate1.declination }}
                        </v-list-tile-sub-title>
                    </v-flex>
            ...
            <v-list-tile v-if="this.data.type.value == 'Raster Scan'">
                <v-list-tile-content class="white--text">
                    ...
                    <v-flex>
                        <v-list-tile-sub-title class="pl-3" v-if="data.declination.value > 0">Right Ascension: 
                            {{ this.appointment.coordinate2.hours }} Hours 
                            {{this.appointment.coordinate2.minutes}} Minutes, 
                            <!-- {{this.appointment.coordinate2.seconds}} Seconds --> 
                            Declination: +{{ this.appointment.coordinate2.declination }}
                        </v-list-tile-sub-title>
                        <v-list-tile-sub-title class="pl-3" v-if="data.declination.value <= 0">Right Ascension: 
                            {{ this.appointment.coordinate2.hours }} Hours 
                            {{this.appointment.coordinate2.minutes}} Minutes, 
                            <!-- {{this.appointment.coordinate2.seconds}} Seconds -->
                            Declination: {{ this.appointment.coordinate2.declination }}</v-list-tile-sub-title>
                    </v-flex>
                </v-list-tile-content>
            </v-list-tile>
            <v-list-tile v-if="(this.data.type.value == 'Celestial Body' && this.data.rightAscension.value != '-') || this.data.type.value === 'Point'">
                <v-list-tile-content class="white--text">
                    ...
                    <v-flex>
                        <v-list-tile-sub-title class="pl-3" v-if="data.declination.value > 0">Right Ascension: 
                            {{ data.rightAscension.hours }} Hours 
                            {{data.rightAscension.minutes}} Minutes, 
                            <!-- {{data.rightAscension.seconds}} Seconds --> 
                            Declination: +{{ data.declination.value }}
                        </v-list-tile-sub-title>
                        <v-list-tile-sub-title class="pl-3" v-if="data.declination.value <= 0">Right Ascension: 
                            {{ data.rightAscension.hours }} Hours 
                            {{data.rightAscension.minutes}} Minutes,
